                        ...
                        <div>
                            ...
                            <div className="sort-r-w">
                                ...
                                <div style={{display:'flex',}}>
                                    <img src={require('./img/sort9@2.jpg')} className="sort-pic-t" alt=""/>
                                    <img src={require('./img/sort10@2.jpg')} className="sort-pic-t" alt=""/>
                                </div>
                                <div className="sort-r-title">良品好物</div>
                                <div>
                                    <img src={require('./img/sort3@2.jpg')} className="sort-pic1" alt=""/>
                                    <img src={require('./img/sort4@2.jpg')} className="sort-pic2" alt=""/>
                                    <img src={require('./img/sort5@2.jpg')} className="sort-pic2" alt=""/>
                                    ...
                                    <img src={require('./img/sort11@2.jpg')} className="sort-pic1" alt=""/>
                                    <img src={require('./img/sort12@2.jpg')} className="sort-pic2" alt=""/>
                                    <img src={require('./img/sort13@2.jpg')} className="sort-pic2" alt=""/>
                                    <div className="sort-txt-w">
                                        <div className="sort-txt">国酿</div>
                                        <div className="sort-txt">曲奇饼干</div>
                                        <div className="sort-txt">花和香薰</div>
                                    </div>
                                    <img src={require('./img/sort14@2.jpg')} className="sort-pic1" alt=""/>
                                    <img src={require('./img/sort15@2.jpg')} className="sort-pic2" alt=""/>
                            ...
                            <div className="sort-r-w">
                                ...
                                <div>
                                    ...
                                    <img src={require('./img/sort28@2.jpg')} className="sort-pic1" alt=""/>
                                    <img src={require('./img/sort29@2.jpg')} className="sort-pic2" alt=""/>
                                    <img src={require('./img/sort30@2.jpg')} className="sort-pic2" alt=""/>
                                    <div className="sort-txt-w">
                                        <div className="sort-txt">国酿</div>
                                        <div className="sort-txt">曲奇饼干</div>
                                        <div className="sort-txt">花和香薰</div>

...
class Search extends Component {
    ...
    render() {
        ...
        return (
            <div>
                <div style={{display:'flex',flexDirection:'row',height:0.45*rem,width:3.75*rem,backgroundColor:'#f3f4f5',position:'relative',paddingBottom:0.09*rem,borderBottom:'1px solid #e6e6e6'}}>

                    <input style={{position:'relative',width:3.12*rem,height:0.27*rem,marginLeft:0.11*rem,marginTop:0.11*rem,border:'none',borderRadius:1.5*rem,fontFamily:'PingFangSC-Thin',fontSize:0.12*rem,textAlign:'center'}} type="text" placeholder='输入商品关坚持或用户名'/>
